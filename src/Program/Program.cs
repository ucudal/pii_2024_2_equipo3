...
Catalog.Instance.AddPokemon("Butterfree", 100, 65, 52, Flying, Bug,Peck,Peck,Peck,Peck);
Catalog.Instance.AddPokemon("Pidgeot", 105, 69, 53, Normal, Flying, Peck,Scratch,Peck,Peck);
Catalog.Instance.AddPokemon("Sandslash", 112, 61, 53, Ground, null,MudSlap,IronTail,Scratch,Scratch);
