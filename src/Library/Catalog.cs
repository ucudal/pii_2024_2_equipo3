...
//cuando un pokemon es seleccionado, se retira del catalogo para que no pueda ser seleccionado de nuevo
    ...
    public Pokemon AddPokemon(string name, int maxhp, int attackstat, int defensestat,int speed, PokeType type1, PokeType type2,
        IMove move1, IMove move2, IMove move3, IMove move4)
    {
        Pokemon pokemon = new Pokemon(name, maxhp, attackstat, defensestat, speed, type1, type2, move1, move2, move3,
            move4);
