...
public class Arena
{
    ...
    public void Turns()
    {
        ...
        while (vivos);
        {
            ...
            if (cooldown1 == 0)
            {
                ...
                if (accion == "A")
                {
                    while (!chose)
                    {
                        ...
                        foreach (Move movimiento in Pokemon1.Moveset)
                        {
            ...
            {
                this.Pokemon1.Attack(Pokemon2, );//falta agragar manera de guardar specialmove
            ...
            if (cooldown2 == 0)
            {
                ...
                while (!actuo2)
                    ...
                    if (accion2 == "A")
                    {
                        ...
                        {
                            Console.WriteLine("Eliga un ataque");
                            foreach (Move movimiento in Pokemon2.Moveset)
                            {
                                Console.WriteLine($"{movimiento.Name}");
                            }
                            Console.WriteLine("Ingrese ataque: ");
